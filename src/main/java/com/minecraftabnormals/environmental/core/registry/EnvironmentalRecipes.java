...
public class EnvironmentalRecipes {
	...
	public static class RecipeTypes {
		public static final IRecipeType<BakingRecipe> BAKING = IRecipeType.register(Environmental.MOD_ID + ":baking");
		public static final IRecipeType<SawingRecipe> SAWING = IRecipeType.register(Environmental.MOD_ID + ":sawing");
	}
}
