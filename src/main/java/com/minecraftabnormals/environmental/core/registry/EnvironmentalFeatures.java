...
public class EnvironmentalFeatures {
	...
	public static final class Configs {
		public static final BlockClusterFeatureConfig CHERRY_BLOSSOM_FOREST_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).addWeightedBlockstate(Blocks.POPPY.getDefaultState(), 2).addWeightedBlockstate(Blocks.RED_TULIP.getDefaultState(), 2).addWeightedBlockstate(Blocks.WHITE_TULIP.getDefaultState(), 1).addWeightedBlockstate(Blocks.DANDELION.getDefaultState(), 1).addWeightedBlockstate(Blocks.PINK_TULIP.getDefaultState(), 3).addWeightedBlockstate(Blocks.ORANGE_TULIP.getDefaultState(), 1).addWeightedBlockstate(Blocks.LILY_OF_THE_VALLEY.getDefaultState(), 1), SimpleBlockPlacer.PLACER)).tries(64).build();
