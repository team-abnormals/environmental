...
public class EnvironmentalFeatures {
	...
	public static final class Configs {
		...
		public static final BaseTreeFeatureConfig PINK_WISTERIA_TREE_WITH_BEEHIVES_CONFIG = BLUE_WISTERIA_TREE_CONFIG.func_236685_a_(ImmutableList.of(Features.Placements.BEES_002_PLACEMENT));
		...
		public static final BaseTreeFeatureConfig PURPLE_WISTERIA_TREE_WITH_BEEHIVES_CONFIG = BLUE_WISTERIA_TREE_CONFIG.func_236685_a_(ImmutableList.of(Features.Placements.BEES_002_PLACEMENT));
		...
		public static final BaseTreeFeatureConfig WHITE_WISTERIA_TREE_WITH_BEEHIVES_CONFIG = BLUE_WISTERIA_TREE_CONFIG.func_236685_a_(ImmutableList.of(Features.Placements.BEES_002_PLACEMENT));
	...
	public static final class Configured {
		...
		public static final ConfiguredFeature<?, ?> BIRCH_TREE_BLOSSOM_WOODS = Features.BIRCH_TALL.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(1, 0.05F, 2)));
		...
		private static <FC extends IFeatureConfig> void register(String name, ConfiguredFeature<FC, ?> configuredFeature) {
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation(Environmental.MODID, name), configuredFeature);
		}
