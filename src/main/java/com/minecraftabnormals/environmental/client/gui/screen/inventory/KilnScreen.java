...
@OnlyIn(Dist.CLIENT)
public class KilnScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> {
    ...
    public KilnScreen(T screenContainer, PlayerInventory inv, ITextComponent titleIn) {
        super(screenContainer, inv, titleIn);
        this.guiTexture = GUI_TEXTURE;
    }
