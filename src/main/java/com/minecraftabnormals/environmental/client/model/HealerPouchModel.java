...
public class HealerPouchModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public HealerPouchModel(float modelSize) {
		...
		this.straps.texOffs(0, 16).addBox(-4.5F, -0.5F, -2.5F, 9.0F, 9.0F, 5.0F, 0.0F, false);

		this.pouch = new ModelRenderer(this);
		this.pouch.setPos(-1.0F, 23.0F, -1.0F);
		this.straps.addChild(this.pouch);
		this.pouch.texOffs(0, 3).addBox(-2.5F, -22.5F, 3.5F, 7.0F, 9.0F, 4.0F, 0.0F, false);
	}
