...
public class KoiModel<T extends KoiEntity> extends EntityModel<T> {
    ...
    public KoiModel() {
        ...
        this.Whisker1.setRotationPoint(-1.5F, 0.0F, -8.5F);
        ...
        this.BottomFin.setRotationPoint(0.0F, 2.0F, 4.0F);
        ...
        this.LeftFin.setRotationPoint(1.0F, 1.0F, -5.0F);
        ...
        this.TopFin1.setRotationPoint(0.0F, -2.0F, -4.0F);
        ...
        this.Whisker2.setRotationPoint(1.5F, 0.0F, -8.5F);
