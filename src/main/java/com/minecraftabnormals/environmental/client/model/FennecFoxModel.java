...
public class FennecFoxModel extends AgeableModel<FennecFoxEntity> {
    ...
    public FennecFoxModel() {
        ...
        head.setRotationPoint(-1.0F, 16.0F, -3.0F);
        head.setTextureOffset(0, 0).addBox(-2.5F, -1.0F, -5.0F, 7.0F, 5.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(0, 10).addBox(-0.5F, 2.0F, -8.0F, 3.0F, 2.0F, 3.0F, 0.0F, false);
        ...
        legFrontRight.setRotationPoint(0.5F, 19.5F, -2.0F);
        legFrontRight.setTextureOffset(12, 20).addBox(-3.0F, 0.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

        legFrontLeft = new ModelRenderer(this);
        legFrontLeft.setRotationPoint(3.5F, 19.5F, -2.0F);
        legFrontLeft.setTextureOffset(20, 20).addBox(-3.0F, 0.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

        legBackRight = new ModelRenderer(this);
        legBackRight.setRotationPoint(0.5F, 19.5F, 2.0F);
        legBackRight.setTextureOffset(28, 20).addBox(-3.0F, 0.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

        legBackLeft = new ModelRenderer(this);
        legBackLeft.setRotationPoint(3.5F, 19.5F, 2.0F);
        legBackLeft.setTextureOffset(36, 20).addBox(-3.0F, 0.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setRotationPoint(0.0F, 18.0F, -5.0F);
        setRotationAngle(body, 1.5708F, 0.0F, 0.0F);
        body.setTextureOffset(12, 10).addBox(-2.5F, 2.0F, -3.0F, 5.0F, 6.0F, 4.0F, 0.0F, false);

        tail = new ModelRenderer(this);
        tail.setRotationPoint(2.0F, 8.0F, -1.0F);
        body.addChild(tail);
        setRotationAngle(tail, -0.0524F, 0.0F, 0.0F);
        tail.setTextureOffset(0, 15).addBox(-3.5F, 0.0F, -1.0F, 3.0F, 8.0F, 3.0F, 0.0F, false);
    }
