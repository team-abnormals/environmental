package com.minecraftabnormals.environmental.common.block.fluid;
...
//    public int tickRate(IWorldReader p_149738_1_) { return 35; }
    ...
    public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
        if (!(entityIn instanceof SlabfishEntity || entityIn instanceof PigEntity))
            entityIn.setMotionMultiplier(state, new Vector3d(0.9D, (double) 0.8F, 0.9D));
