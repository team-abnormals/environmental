...
public class DuckLayEggInNestGoal extends MoveToBlockGoal {
	...
	public boolean shouldExecute() {
		return !this.duck.isChild() && !this.duck.isDuckJockey() && this.duck.timeUntilNextEgg < 800 && super.shouldExecute();
	}
	...
	public void tick() {
		super.tick();
		if (this.getIsAboveDestination() && !this.duck.isChild() && !this.duck.isDuckJockey() && this.duck.timeUntilNextEgg < 800) {
