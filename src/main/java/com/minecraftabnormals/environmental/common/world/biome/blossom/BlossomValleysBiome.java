...
//import com.minecraftabnormals.abnormals_core.common.world.biome.AbnormalsBiome;
//
...
//        EnvironmentalBiomeFeatures.addShortFlower(EnvironmentalFeatureConfigs.WHITE_LOTUS_FLOWER, this, 3);
//
...
//
//        this.addSpawn(EntityClassification.WATER_AMBIENT, new Biome.SpawnListEntry(EnvironmentalEntities.KOI.get(), 12, 1, 3));
//
