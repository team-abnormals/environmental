...
public class EnvironmentalFeatureConfigs {
	...
	public static final BlockClusterFeatureConfig CHERRY_BLOSSOM_FOREST_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((
			new WeightedBlockStateProvider())
			.addWeightedBlockstate(Blocks.POPPY.getDefaultState(), 2)
