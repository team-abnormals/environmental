...
public class BiomeFeatures {
	...
	public static final TreeFeatureConfig PURPLE_WISTERIA_NO_BEEHIVES_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(PURPLE_WISTERIA_LEAVES), new BlobFoliagePlacer(2, 0))).setSapling((net.minecraftforge.common.IPlantable)EnvironmentalBlocks.PURPLE_WISTERIA_SAPLING.get()).build();
	...
	public static final TreeFeatureConfig PURPLE_WISTERIA_MORE_BEEHIVES_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(PURPLE_WISTERIA_LEAVES), new BlobFoliagePlacer(2, 0))).decorators(ImmutableList.of(new BeehiveTreeDecorator(0.05F))).setSapling((net.minecraftforge.common.IPlantable)EnvironmentalBlocks.PURPLE_WISTERIA_SAPLING.get()).build();
	
	public static final TreeFeatureConfig WHITE_WISTERIA_NO_BEEHIVES_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(WHITE_WISTERIA_LEAVES), new BlobFoliagePlacer(2, 0))).setSapling((net.minecraftforge.common.IPlantable)EnvironmentalBlocks.WHITE_WISTERIA_SAPLING.get()).build();
	...
	public static final TreeFeatureConfig WHITE_WISTERIA_MORE_BEEHIVES_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(WHITE_WISTERIA_LEAVES), new BlobFoliagePlacer(2, 0))).decorators(ImmutableList.of(new BeehiveTreeDecorator(0.05F))).setSapling((net.minecraftforge.common.IPlantable)EnvironmentalBlocks.WHITE_WISTERIA_SAPLING.get()).build();
