...
public class EnvironmentalFeatureConfigs {
	...
	public static final BaseTreeFeatureConfig PURPLE_WISTERIA_NO_BEEHIVES_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(PURPLE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236701_a_(1).build();
	public static final BaseTreeFeatureConfig PURPLE_WISTERIA_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(PURPLE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236703_a_(ImmutableList.of(new BeehiveTreeDecorator(0.002F))).func_236701_a_(1).build();
	public static final BaseTreeFeatureConfig PURPLE_WISTERIA_MORE_BEEHIVES_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(PURPLE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236703_a_(ImmutableList.of(new BeehiveTreeDecorator(0.05F))).func_236701_a_(1).build();
	
	public static final BaseTreeFeatureConfig WHITE_WISTERIA_NO_BEEHIVES_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(WHITE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236701_a_(1).build();
	public static final BaseTreeFeatureConfig WHITE_WISTERIA_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(WHITE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236703_a_(ImmutableList.of(new BeehiveTreeDecorator(0.002F))).func_236701_a_(1).build();
	public static final BaseTreeFeatureConfig WHITE_WISTERIA_MORE_BEEHIVES_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WISTERIA_LOG), new SimpleBlockStateProvider(WHITE_WISTERIA_LEAVES), new BlobFoliagePlacer(0, 0, 0, 0, 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0))).func_236703_a_(ImmutableList.of(new BeehiveTreeDecorator(0.05F))).func_236701_a_(1).build();
