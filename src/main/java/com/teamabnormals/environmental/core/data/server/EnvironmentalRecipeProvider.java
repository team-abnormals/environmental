...
public class EnvironmentalRecipeProvider extends RecipeProvider {
	...
	public void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapelessRecipeBuilder.shapeless(EnvironmentalItems.CHERRY_PIE.get()).requires(Ingredient.of(EnvironmentalTags.Items.FRUITS_CHERRY), 3).requires(Items.SUGAR).requires(BlueprintItemTags.EGGS).unlockedBy("has_cherry", has(EnvironmentalTags.Items.FRUITS_CHERRY)).save(consumer);
		...
		planksFromLogs(consumer, EnvironmentalBlocks.WILLOW_PLANKS.get(), EnvironmentalTags.Items.WILLOW_LOGS);
		...
		leafCarpetRecipe(consumer, EnvironmentalBlocks.WILLOW_LEAVES.get(), EnvironmentalBlocks.WILLOW_LEAF_CARPET.get(), EnvironmentalBlocks.WILLOW_HEDGE.get(), EnvironmentalTags.Items.WILLOW_LOGS);
		woodenBoat(consumer, EnvironmentalItems.WILLOW_BOAT.get(), EnvironmentalBlocks.WILLOW_PLANKS.get());
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.WILLOW_FURNACE_BOAT.get()).define('F', Items.FURNACE).define('B', EnvironmentalItems.WILLOW_BOAT.get()).pattern("F").pattern("B").group("furnace_boat").unlockedBy(getHasName(EnvironmentalItems.WILLOW_BOAT.get()), has(EnvironmentalItems.WILLOW_BOAT.get())));
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.LARGE_WILLOW_BOAT.get()).define('#', EnvironmentalBlocks.WILLOW_PLANKS.get()).define('B', EnvironmentalItems.WILLOW_BOAT.get()).pattern("#B#").pattern("###").group("large_boat").unlockedBy(getHasName(EnvironmentalItems.WILLOW_BOAT.get()), has(EnvironmentalItems.WILLOW_BOAT.get())));
		...
		conditionalRecipe(consumer, WOOD_TO_CHEST_RECIPES, ShapedRecipeBuilder.shaped(EnvironmentalBlocks.WILLOW_CHESTS.getFirst().get(), 4).define('#', EnvironmentalTags.Items.WILLOW_LOGS).pattern("###").pattern("# #").pattern("###").group("wooden_chest").unlockedBy("has_lots_of_items", new InventoryChangeTrigger.TriggerInstance(EntityPredicate.Composite.ANY, MinMaxBounds.Ints.atLeast(10), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, new ItemPredicate[0])), new ResourceLocation(RecipeBuilder.getDefaultRecipeId(EnvironmentalBlocks.WILLOW_CHESTS.getFirst().get()) + "_wood"));

		generateRecipes(consumer, EnvironmentalBlockFamilies.WISTERIA_PLANKS_FAMILY);
		planksFromLogs(consumer, EnvironmentalBlocks.WISTERIA_PLANKS.get(), EnvironmentalTags.Items.WISTERIA_LOGS);
		...
		leafCarpetRecipe(consumer, EnvironmentalBlocks.PINK_WISTERIA_LEAVES.get(), EnvironmentalBlocks.PINK_WISTERIA_LEAF_CARPET.get(), EnvironmentalBlocks.PINK_WISTERIA_HEDGE.get(), EnvironmentalTags.Items.WISTERIA_LOGS);
		leafCarpetRecipe(consumer, EnvironmentalBlocks.BLUE_WISTERIA_LEAVES.get(), EnvironmentalBlocks.BLUE_WISTERIA_LEAF_CARPET.get(), EnvironmentalBlocks.BLUE_WISTERIA_HEDGE.get(), EnvironmentalTags.Items.WISTERIA_LOGS);
		leafCarpetRecipe(consumer, EnvironmentalBlocks.PURPLE_WISTERIA_LEAVES.get(), EnvironmentalBlocks.PURPLE_WISTERIA_LEAF_CARPET.get(), EnvironmentalBlocks.PURPLE_WISTERIA_HEDGE.get(), EnvironmentalTags.Items.WISTERIA_LOGS);
		leafCarpetRecipe(consumer, EnvironmentalBlocks.WHITE_WISTERIA_LEAVES.get(), EnvironmentalBlocks.WHITE_WISTERIA_LEAF_CARPET.get(), EnvironmentalBlocks.WHITE_WISTERIA_HEDGE.get(), EnvironmentalTags.Items.WISTERIA_LOGS);
		woodenBoat(consumer, EnvironmentalItems.WISTERIA_BOAT.get(), EnvironmentalBlocks.WISTERIA_PLANKS.get());
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.WISTERIA_FURNACE_BOAT.get()).define('F', Items.FURNACE).define('B', EnvironmentalItems.WISTERIA_BOAT.get()).pattern("F").pattern("B").group("furnace_boat").unlockedBy(getHasName(EnvironmentalItems.WISTERIA_BOAT.get()), has(EnvironmentalItems.WISTERIA_BOAT.get())));
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.LARGE_WISTERIA_BOAT.get()).define('#', EnvironmentalBlocks.WISTERIA_PLANKS.get()).define('B', EnvironmentalItems.WISTERIA_BOAT.get()).pattern("#B#").pattern("###").group("large_boat").unlockedBy(getHasName(EnvironmentalItems.WISTERIA_BOAT.get()), has(EnvironmentalItems.WISTERIA_BOAT.get())));
		...
		leafCarpetRecipe(consumer, EnvironmentalBlocks.CHERRY_LEAVES.get(), EnvironmentalBlocks.CHERRY_LEAF_CARPET.get(), EnvironmentalBlocks.CHERRY_HEDGE.get(), EnvironmentalTags.Items.CHERRY_LOGS);
		woodenBoat(consumer, EnvironmentalItems.CHERRY_BOAT.get(), EnvironmentalBlocks.CHERRY_PLANKS.get());
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.CHERRY_FURNACE_BOAT.get()).define('F', Items.FURNACE).define('B', EnvironmentalItems.CHERRY_BOAT.get()).pattern("F").pattern("B").group("furnace_boat").unlockedBy(getHasName(EnvironmentalItems.CHERRY_BOAT.get()), has(EnvironmentalItems.CHERRY_BOAT.get())));
		conditionalRecipe(consumer, BOATLOAD_LOADED, ShapedRecipeBuilder.shaped(EnvironmentalItems.LARGE_CHERRY_BOAT.get()).define('#', EnvironmentalBlocks.CHERRY_PLANKS.get()).define('B', EnvironmentalItems.CHERRY_BOAT.get()).pattern("#B#").pattern("###").group("large_boat").unlockedBy(getHasName(EnvironmentalItems.CHERRY_BOAT.get()), has(EnvironmentalItems.CHERRY_BOAT.get())));
