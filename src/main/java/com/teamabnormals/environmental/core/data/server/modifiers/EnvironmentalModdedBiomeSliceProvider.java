...
public class EnvironmentalModdedBiomeSliceProvider extends ModdedBiomeSliceProvider {
	...
	private static final class EnvironmentalBiomeBuilder {
		...
		private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {EnvironmentalBiomes.BLOSSOM_VALLEYS.getKey(), EnvironmentalBiomes.BLOSSOM_VALLEYS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_VALLEYS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey()}, {EnvironmentalBiomes.BLOSSOM_VALLEYS.getKey(), EnvironmentalBiomes.BLOSSOM_VALLEYS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey()}, {VANILLA, VANILLA, EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
		...
		private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}, {EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey()}, {EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), EnvironmentalBiomes.BLOSSOM_WOODS.getKey()}, {VANILLA, VANILLA, EnvironmentalBiomes.BLOSSOM_WOODS.getKey(), VANILLA, VANILLA}, {VANILLA, VANILLA, VANILLA, VANILLA, VANILLA}};
