...
public class EnvironmentalBiomeSlices {
	...
	private static final class EnvironmentalBiomeBuilder {
		...
		private final ResourceKey<Biome>[][] SHATTERED_BIOMES = new ResourceKey[][]{
				{VANILLA, VANILLA, VANILLA, VANILLA, VANILLA},
				{VANILLA, VANILLA, PINE_BARRENS_AREA, VANILLA, VANILLA},
				{VANILLA, VANILLA, PINE_BARRENS_AREA, BLOSSOM_WOODS_AREA, BLOSSOM_WOODS_AREA},
				{null, null, null, null, null},
				{null, null, null, null, null}};
		...
		private void addInlandBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> consumer) {
			...
			this.addValleys(consumer, Climate.Parameter.span(-0.15F, -0.05F), 2);
			...
			this.addValleys(consumer, Climate.Parameter.span(0.05F, 0.15F), 2);
		...
		private ResourceKey<Biome> pickSlopeBiome(int p_187245_, int p_187246_, Climate.Parameter p_187247_) {
			if (p_187245_ >= 3) {
				...
				return p_187245_ < 1 ? VANILLA : PINE_SLOPES_AREA;
			}
		}
