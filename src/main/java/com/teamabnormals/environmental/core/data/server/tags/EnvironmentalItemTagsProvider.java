...
public class EnvironmentalItemTagsProvider extends ItemTagsProvider {
	...
	public void addTags() {
		...
		this.tag(EnvironmentalItemTags.DEER_TEMPT_ITEMS).add(Items.MELON_SLICE, Items.GLISTERING_MELON_SLICE).addTag(EnvironmentalItemTags.DEER_FOOD).addTag(ItemTags.FLOWERS);
		...
		this.tag(ItemTags.BOATS).add(WILLOW_BOAT.get(), WISTERIA_BOAT.get(), CHERRY_BOAT.get());
