...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(DIRT_BRICKS.get(), DIRT_BRICK_STAIRS.get(), DIRT_BRICK_SLAB.get(), DIRT_BRICK_WALL.get(), DIRT_BRICK_VERTICAL_SLAB.get(), DIRT_TILES.get(), DIRT_TILE_STAIRS.get(), DIRT_TILE_SLAB.get(), DIRT_TILE_WALL.get(), DIRT_TILE_VERTICAL_SLAB.get(), BURIED_TRUFFLE.get(), PODZOL_PATH.get(), MYCELIUM_PATH.get());
