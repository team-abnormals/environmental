...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(
				...
				CEDAR_LEAVES.get(), CEDAR_LEAF_PILE.get(),
		...
		this.tag(BlockTags.FLOWER_POTS).add(
				...
				POTTED_CARTWHEEL.get(), POTTED_BLUEBELL.get(), POTTED_VIOLET.get(), POTTED_DIANTHUS.get(),
				POTTED_RED_LOTUS_FLOWER.get(), POTTED_WHITE_LOTUS_FLOWER.get(), POTTED_TASSELFLOWER.get(),
				POTTED_YELLOW_HIBISCUS.get(), POTTED_ORANGE_HIBISCUS.get(), POTTED_RED_HIBISCUS.get(), POTTED_PINK_HIBISCUS.get(), POTTED_MAGENTA_HIBISCUS.get(), POTTED_PURPLE_HIBISCUS.get(),
				POTTED_BIRD_OF_PARADISE.get(), POTTED_PINK_DELPHINIUM.get(), POTTED_BLUE_DELPHINIUM.get(), POTTED_PURPLE_DELPHINIUM.get(), POTTED_WHITE_DELPHINIUM.get(),
				POTTED_CATTAIL.get(), POTTED_CUP_LICHEN.get(), POTTED_SHRUB.get(), POTTED_FLOWERING_SHRUB.get(), POTTED_DWARF_SPRUCE.get()
		);
		...
		this.tag(BlockTags.TALL_FLOWERS).add(BIRD_OF_PARADISE.get(), PINK_DELPHINIUM.get(), BLUE_DELPHINIUM.get(), PURPLE_DELPHINIUM.get(), WHITE_DELPHINIUM.get(), FLOWERING_SHRUB.get(), BEAMING_SUNFLOWER.get(), BLAZING_SUNFLOWER.get(), ECLIPSED_SUNFLOWER.get(), RADIANT_SUNFLOWER.get());

		this.tag(BlockTags.SAPLINGS).add(WILLOW_SAPLING.get(), PINE_SAPLING.get(), CEDAR_SAPLING.get(), PINK_WISTERIA_SAPLING.get(), BLUE_WISTERIA_SAPLING.get(), PURPLE_WISTERIA_SAPLING.get(), WHITE_WISTERIA_SAPLING.get(), PLUM_SAPLING.get(), CHEERFUL_PLUM_SAPLING.get(), MOODY_PLUM_SAPLING.get());
		...
		this.tag(BlockTags.WOODEN_DOORS).add(WILLOW_DOOR.get(), PINE_DOOR.get(), CEDAR_DOOR.get(), WISTERIA_DOOR.get(), PLUM_DOOR.get());
		this.tag(BlockTags.WOODEN_FENCES).add(WILLOW_FENCE.get(), PINE_FENCE.get(), CEDAR_FENCE.get(), WISTERIA_FENCE.get(), PLUM_FENCE.get());
		this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(WILLOW_PRESSURE_PLATE.get(), PINE_PRESSURE_PLATE.get(), CEDAR_PRESSURE_PLATE.get(), WISTERIA_PRESSURE_PLATE.get(), PLUM_PRESSURE_PLATE.get());
		this.tag(BlockTags.WOODEN_SLABS).add(WILLOW_SLAB.get(), PINE_SLAB.get(), CEDAR_SLAB.get(), WISTERIA_SLAB.get(), PLUM_SLAB.get());
		this.tag(BlockTags.WOODEN_STAIRS).add(WILLOW_STAIRS.get(), PINE_STAIRS.get(), CEDAR_STAIRS.get(), WISTERIA_STAIRS.get(), PLUM_STAIRS.get());
		this.tag(BlockTags.WOODEN_TRAPDOORS).add(WILLOW_TRAPDOOR.get(), PINE_TRAPDOOR.get(), CEDAR_TRAPDOOR.get(), WISTERIA_TRAPDOOR.get(), PLUM_TRAPDOOR.get());
		this.tag(BlockTags.FENCE_GATES).add(WILLOW_FENCE_GATE.get(), PINE_FENCE_GATE.get(), CEDAR_FENCE_GATE.get(), WISTERIA_FENCE_GATE.get(), PLUM_FENCE_GATE.get());

		this.tag(BlockTags.STANDING_SIGNS).add(WILLOW_SIGNS.getFirst().get(), PINE_SIGNS.getFirst().get(), CEDAR_SIGNS.getFirst().get(), WISTERIA_SIGNS.getFirst().get(), PLUM_SIGNS.getFirst().get());
		this.tag(BlockTags.WALL_SIGNS).add(WILLOW_SIGNS.getSecond().get(), PINE_SIGNS.getSecond().get(), CEDAR_SIGNS.getSecond().get(), WISTERIA_SIGNS.getSecond().get(), PLUM_SIGNS.getSecond().get());
		this.tag(BlockTags.CEILING_HANGING_SIGNS).add(WILLOW_HANGING_SIGNS.getFirst().get(), PINE_HANGING_SIGNS.getFirst().get(), CEDAR_HANGING_SIGNS.getFirst().get(), PLUM_HANGING_SIGNS.getFirst().get(), WISTERIA_HANGING_SIGNS.getFirst().get());
		this.tag(BlockTags.WALL_HANGING_SIGNS).add(WILLOW_HANGING_SIGNS.getSecond().get(), PINE_HANGING_SIGNS.getSecond().get(), CEDAR_HANGING_SIGNS.getSecond().get(), PLUM_HANGING_SIGNS.getSecond().get(), WISTERIA_HANGING_SIGNS.getSecond().get());

		this.tag(BlockTags.REPLACEABLE).add(Blocks.PINK_PETALS, HANGING_WILLOW_LEAVES.get(), PINK_HANGING_WISTERIA_LEAVES.get(), BLUE_HANGING_WISTERIA_LEAVES.get(), PURPLE_HANGING_WISTERIA_LEAVES.get(), WHITE_HANGING_WISTERIA_LEAVES.get(), GIANT_TALL_GRASS.get(), MYCELIUM_SPROUTS.get(), CUP_LICHEN.get(), SHRUB.get(), FLOWERING_SHRUB.get(), BIRD_OF_PARADISE.get(), PINK_DELPHINIUM.get(), BLUE_DELPHINIUM.get(), PURPLE_DELPHINIUM.get(), WHITE_DELPHINIUM.get(), CACTUS_BOBBLE.get(), BEAMING_SUNFLOWER.get(), BLAZING_SUNFLOWER.get(), ECLIPSED_SUNFLOWER.get(), RADIANT_SUNFLOWER.get());
		this.tag(BlockTags.REPLACEABLE_BY_TREES).add(TREE_LICHEN.get());
		...
		this.tag(BlockTags.GUARDED_BY_PIGLINS).add(WILLOW_CHEST.get(), TRAPPED_WILLOW_CHEST.get(), PINE_CHEST.get(), TRAPPED_PINE_CHEST.get(), CEDAR_CHEST.get(), TRAPPED_CEDAR_CHEST.get(), WISTERIA_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), PLUM_CHEST.get(), TRAPPED_PLUM_CHEST.get());
		...
		this.tag(MUD_REPLACEABLES).add(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.SAND, Blocks.CLAY, MUDDY_SAND.get());
		...
		this.tag(BlockTags.SWORD_EFFICIENT).add(MYCELIUM_SPROUTS.get(), DWARF_SPRUCE.get(), HANGING_WILLOW_LEAVES.get(),
				...
				BEAMING_SUNFLOWER.get(), BLAZING_SUNFLOWER.get(), ECLIPSED_SUNFLOWER.get(), RADIANT_SUNFLOWER.get(),
				CUP_LICHEN.get(), TREE_LICHEN.get(), SHRUB.get(), FLOWERING_SHRUB.get(), DUCKWEED.get(), CACTUS_BOBBLE.get()
		);
		...
		this.tag(CEDAR_LOGS).add(CEDAR_LOG.get(), CEDAR_WOOD.get(), STRIPPED_CEDAR_LOG.get(), STRIPPED_CEDAR_WOOD.get());
		...
		this.tag(BlueprintBlockTags.WOODEN_CHESTS).add(WILLOW_CHEST.get(), PINE_CHEST.get(), CEDAR_CHEST.get(), WISTERIA_CHEST.get(), PLUM_CHEST.get());
		this.tag(BlueprintBlockTags.WOODEN_TRAPPED_CHESTS).add(TRAPPED_WILLOW_CHEST.get(), TRAPPED_PINE_CHEST.get(), TRAPPED_CEDAR_CHEST.get(), TRAPPED_WISTERIA_CHEST.get(), TRAPPED_PLUM_CHEST.get());
		this.tag(BlueprintBlockTags.WOODEN_LADDERS).add(WILLOW_LADDER.get(), PINE_LADDER.get(), CEDAR_LADDER.get(), WISTERIA_LADDER.get(), PLUM_LADDER.get());
		this.tag(BlueprintBlockTags.WOODEN_BEEHIVES).add(WILLOW_BEEHIVE.get(), PINE_BEEHIVE.get(), CEDAR_BEEHIVE.get(), WISTERIA_BEEHIVE.get(), PLUM_BEEHIVE.get());
		this.tag(BlueprintBlockTags.WOODEN_BOOKSHELVES).add(WILLOW_BOOKSHELF.get(), PINE_BOOKSHELF.get(), CEDAR_BOOKSHELF.get(), WISTERIA_BOOKSHELF.get(), PLUM_BOOKSHELF.get());
		this.tag(BlueprintBlockTags.WOODEN_CHISELED_BOOKSHELVES).add(CHISELED_WILLOW_BOOKSHELF.get(), CHISELED_PINE_BOOKSHELF.get(), CHISELED_CEDAR_BOOKSHELF.get(), CHISELED_WISTERIA_BOOKSHELF.get(), CHISELED_PLUM_BOOKSHELF.get());

		this.tag(BlueprintBlockTags.WOODEN_BOARDS).add(WILLOW_BOARDS.get(), PINE_BOARDS.get(), CEDAR_BOARDS.get(), WISTERIA_BOARDS.get(), PLUM_BOARDS.get());
		this.tag(BlueprintBlockTags.LEAF_PILES).add(WILLOW_LEAF_PILE.get(), PINE_LEAF_PILE.get(), CEDAR_LEAF_PILE.get(), WISTERIA_LEAF_PILE.get(), PINK_WISTERIA_LEAF_PILE.get(), BLUE_WISTERIA_LEAF_PILE.get(), PURPLE_WISTERIA_LEAF_PILE.get(), WHITE_WISTERIA_LEAF_PILE.get(), PLUM_LEAF_PILE.get(), CHEERFUL_PLUM_LEAF_PILE.get(), MOODY_PLUM_LEAF_PILE.get(), HIBISCUS_LEAF_PILE.get());
