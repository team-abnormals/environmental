...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				...
				CATTAIL_SPROUT.get(), CATTAIL.get(), LARGE_LILY_PAD.get(), GIANT_LILY_PAD.get(), GIANT_TALL_GRASS.get(), MYCELIUM_SPROUTS.get(), CUP_LICHEN.get(),
		...
		this.tag(BlockTags.RABBITS_SPAWNABLE_ON).add(Blocks.STONE, Blocks.GRAVEL, Blocks.COARSE_DIRT);
