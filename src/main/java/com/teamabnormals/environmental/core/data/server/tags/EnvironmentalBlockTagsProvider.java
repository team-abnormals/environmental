...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(
				...
				SMOOTHCAP_MOSS_BLOCK.get()
		);

		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				SMOOTH_MUD.get(), SMOOTH_MUD_SLAB.get(), CHISELED_MUD_BRICKS.get(), SLABFISH_EFFIGY.get(),
				MUDDY_SANDSTONE.get(), MUDDY_SANDSTONE_STAIRS.get(), MUDDY_SANDSTONE_SLAB.get(), MUDDY_SANDSTONE_WALL.get(), CHISELED_MUDDY_SANDSTONE.get(), SMOOTH_MUDDY_SANDSTONE.get(), SMOOTH_MUDDY_SANDSTONE_STAIRS.get(), SMOOTH_MUDDY_SANDSTONE_SLAB.get(), CUT_MUDDY_SANDSTONE.get(), CUT_MUDDY_SANDSTONE_SLAB.get(), BOG_IRON_BLOCK.get()
		);
		this.tag(BlockTags.NEEDS_STONE_TOOL).add(BOG_IRON_BLOCK.get());

		this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(DIRT_BRICKS.get(), DIRT_BRICK_STAIRS.get(), DIRT_BRICK_SLAB.get(), DIRT_BRICK_WALL.get(), DIRT_TILES.get(), DIRT_TILE_STAIRS.get(), DIRT_TILE_SLAB.get(), DIRT_TILE_WALL.get(), MUDDY_SAND.get(), SUSPICIOUS_MUDDY_SAND.get(), MUDDY_PODZOL.get(), BURIED_TRUFFLE.get(), DIRT_PATH.get(), PODZOL_PATH.get(), MYCELIUM_PATH.get(), MUD_PATH.get(), MUDDY_PODZOL_PATH.get());

		this.tag(MINEABLE_WITH_KNIFE).add(YAK_HAIR_BLOCK.get(), YAK_HAIR_RUG.get());
		this.tag(COMPOST_ACTIVATORS).add(MYCELIUM_SPROUTS.get());

		this.tag(BlockTags.SLABS).add(GRASS_THATCH_SLAB.get(), CATTAIL_THATCH_SLAB.get(), DUCKWEED_THATCH_SLAB.get(), DIRT_BRICK_SLAB.get(), DIRT_TILE_SLAB.get(), SMOOTH_MUD_SLAB.get(), MUDDY_SANDSTONE_SLAB.get(), SMOOTH_MUDDY_SANDSTONE_SLAB.get(), CUT_MUDDY_SANDSTONE_SLAB.get());
		this.tag(BlockTags.STAIRS).add(GRASS_THATCH_STAIRS.get(), CATTAIL_THATCH_STAIRS.get(), DUCKWEED_THATCH_STAIRS.get(), DIRT_BRICK_STAIRS.get(), DIRT_TILE_STAIRS.get(), MUDDY_SANDSTONE_STAIRS.get(), SMOOTH_MUDDY_SANDSTONE_STAIRS.get());
		this.tag(BlockTags.WALLS).add(DIRT_BRICK_WALL.get(), DIRT_TILE_WALL.get(), MUDDY_SANDSTONE_WALL.get());

		this.tag(Tags.Blocks.GLASS_BLOCKS).add(MUDGLASS.get());
		this.tag(Tags.Blocks.GLASS_PANES).add(MUDGLASS_PANE.get());

		this.tag(BlockTags.DIRT).add(DIRT_BRICKS.get(), DIRT_BRICK_STAIRS.get(), DIRT_BRICK_SLAB.get(), DIRT_BRICK_WALL.get(), DIRT_TILES.get(), DIRT_TILE_STAIRS.get(), DIRT_TILE_SLAB.get(), DIRT_TILE_WALL.get(), MUDDY_SAND.get(), SUSPICIOUS_MUDDY_SAND.get(), MUDDY_PODZOL.get(), SMOOTHCAP_MOSS_BLOCK.get());
		this.tag(BlockTags.SAND).add(MUDDY_SAND.get(), SUSPICIOUS_MUDDY_SAND.get());
		...
		this.tag(BlockTags.SNIFFER_DIGGABLE_BLOCK).add(MUDDY_SAND.get(), MUDDY_PODZOL.get(), SMOOTHCAP_MOSS_BLOCK.get());
		this.tag(BlockTags.SNIFFER_EGG_HATCH_BOOST).add(SMOOTHCAP_MOSS_BLOCK.get());
		this.tag(BlockTags.FLOWER_POTS).add(
				...
				POTTED_RED_LOTUS_FLOWER.get(), POTTED_WHITE_LOTUS_FLOWER.get(), POTTED_TASSELFLOWER.get(), POTTED_ESTUARY_MARIGOLD.get(),
		...
		this.tag(BlockTags.SMALL_FLOWERS).addTag(HIBISCUSES).addTag(WALL_HIBISCUSES).add(CARTWHEEL.get(), BLUEBELL.get(), VIOLET.get(), DIANTHUS.get(), RED_LOTUS_FLOWER.get(), WHITE_LOTUS_FLOWER.get(), TASSELFLOWER.get(), ESTUARY_MARIGOLD.get());
		...
		this.tag(BlockTags.REPLACEABLE).add(Blocks.PINK_PETALS, HANGING_WILLOW_LEAVES.get(), PINK_HANGING_WISTERIA_LEAVES.get(), BLUE_HANGING_WISTERIA_LEAVES.get(), PURPLE_HANGING_WISTERIA_LEAVES.get(), WHITE_HANGING_WISTERIA_LEAVES.get(), GIANT_TALL_GRASS.get(), MYCELIUM_SPROUTS.get(), CUP_LICHEN.get(), SHRUB.get(), FLOWERING_SHRUB.get(), SMOOTHCAP_MOSS.get(), BIRD_OF_PARADISE.get(), PINK_DELPHINIUM.get(), BLUE_DELPHINIUM.get(), PURPLE_DELPHINIUM.get(), WHITE_DELPHINIUM.get(), CACTUS_BOBBLE.get(), BEAMING_SUNFLOWER.get(), BLAZING_SUNFLOWER.get(), ECLIPSED_SUNFLOWER.get(), RADIANT_SUNFLOWER.get());
		this.tag(BlockTags.REPLACEABLE_BY_TREES).add(TREE_LICHEN.get(), SMOOTHCAP_MOSS.get());
		this.tag(BlockTags.OVERWORLD_CARVER_REPLACEABLES).add(MUDDY_SANDSTONE.get());
		this.tag(BlockTags.SMALL_DRIPLEAF_PLACEABLE).add(SMOOTHCAP_MOSS_BLOCK.get());
		this.tag(BlockTags.SCULK_REPLACEABLE).add(MUDDY_SANDSTONE.get());
		...
		this.tag(TRACKABLE_BY_TAPIRS).addTag(BlockTags.SWORD_EFFICIENT).add(Blocks.MOSS_BLOCK, SMOOTHCAP_MOSS_BLOCK.get(), Blocks.BAMBOO, Blocks.BAMBOO_SAPLING, Blocks.CACTUS, Blocks.BEE_NEST);
		this.tag(BlockTags.SWORD_EFFICIENT).add(MYCELIUM_SPROUTS.get(), DWARF_SPRUCE.get(), HANGING_WILLOW_LEAVES.get(),
				...
				CUP_LICHEN.get(), TREE_LICHEN.get(), SHRUB.get(), FLOWERING_SHRUB.get(), SMOOTHCAP_MOSS.get(), DUCKWEED.get(), CACTUS_BOBBLE.get()
		);
		...
		this.tag(Tags.Blocks.STORAGE_BLOCKS).addTags(
				STORAGE_BLOCKS_CHERRY, STORAGE_BLOCKS_PLUM, STORAGE_BLOCKS_DUCK_EGG, STORAGE_BLOCKS_CATTAIL_FLUFF
		).add(BOG_IRON_BLOCK.get());
