...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				MUD_BRICKS.get(), MUD_BRICK_SLAB.get(), MUD_BRICK_STAIRS.get(), MUD_BRICK_WALL.get(), MUD_BRICK_VERTICAL_SLAB.get(), CHISELED_MUD_BRICKS.get(), SLABFISH_EFFIGY.get()
		);

		this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(MUD.get(), BURIED_TRUFFLE.get(), PODZOL_PATH.get(), MYCELIUM_PATH.get());
		...
		this.tag(BlockTags.SLABS).add(GRASS_THATCH_SLAB.get(), CATTAIL_THATCH_SLAB.get(), DUCKWEED_THATCH_SLAB.get(), MUD_BRICK_SLAB.get());
		this.tag(BlockTags.STAIRS).add(GRASS_THATCH_STAIRS.get(), CATTAIL_THATCH_STAIRS.get(), DUCKWEED_THATCH_STAIRS.get(), MUD_BRICK_STAIRS.get());
		this.tag(BlockTags.WALLS).add(MUD_BRICK_WALL.get());
		this.tag(BlueprintBlockTags.VERTICAL_SLABS).add(GRASS_THATCH_VERTICAL_SLAB.get(), CATTAIL_THATCH_VERTICAL_SLAB.get(), DUCKWEED_THATCH_VERTICAL_SLAB.get(), MUD_BRICK_VERTICAL_SLAB.get());

		this.tag(BlockTags.DIRT).add(MUD.get());
