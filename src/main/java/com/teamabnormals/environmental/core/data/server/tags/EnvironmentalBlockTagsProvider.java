...
public class EnvironmentalBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.CLIMBABLE).add(WILLOW_LADDER.get(), WISTERIA_LADDER.get(), CHERRY_LADDER.get(), PINK_HANGING_WISTERIA_LEAVES.get(), PURPLE_HANGING_WISTERIA_LEAVES.get(), BLUE_HANGING_WISTERIA_LEAVES.get(), WHITE_HANGING_WISTERIA_LEAVES.get());
		...
		this.tag(BlockTags.LEAVES).add(WILLOW_LEAVES.get(), WISTERIA_LEAVES.get(), PINK_WISTERIA_LEAVES.get(), BLUE_WISTERIA_LEAVES.get(), PURPLE_WISTERIA_LEAVES.get(), WHITE_WISTERIA_LEAVES.get(), CHERRY_LEAVES.get(), HIBISCUS_LEAVES.get());
		...
		this.tag(BlueprintBlockTags.LEAF_PILES).add(WILLOW_LEAF_PILE.get(), WISTERIA_LEAF_PILE.get(), PINK_WISTERIA_LEAF_PILE.get(), BLUE_WISTERIA_LEAF_PILE.get(), PURPLE_WISTERIA_LEAF_PILE.get(), WHITE_WISTERIA_LEAF_PILE.get(), CHERRY_LEAF_PILE.get(), HIBISCUS_LEAF_PILE.get());
		...
		this.tag(BlueprintBlockTags.HEDGES).add(WILLOW_HEDGE.get(), WISTERIA_HEDGE.get(), PINK_WISTERIA_HEDGE.get(), BLUE_WISTERIA_HEDGE.get(), PURPLE_WISTERIA_HEDGE.get(), WHITE_WISTERIA_HEDGE.get(), CHERRY_HEDGE.get());
	}
}