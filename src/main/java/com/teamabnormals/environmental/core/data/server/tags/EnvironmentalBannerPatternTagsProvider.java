...
import com.teamabnormals.environmental.core.registry.datapack.EnvironmentalBannerPatterns;
...
public class EnvironmentalBannerPatternTagsProvider extends BannerPatternTagsProvider {
	...
	public void addTags(Provider provider) {
		this.tag(EnvironmentalBannerPatternTags.PATTERN_ITEM_LUMBERER).add(EnvironmentalBannerPatterns.LUMBERER);
		this.tag(EnvironmentalBannerPatternTags.PATTERN_ITEM_HELPER).add(EnvironmentalBannerPatterns.HELPER);
	}
}