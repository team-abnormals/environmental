...
public class EnvironmentalBiomeModifiers {
	...
	public static void bootstrap(BootstapContext<BiomeModifier> context) {
		...
		addFeatureIgnore(context, "dwarf_spruce_sparse", EnvironmentalBiomeTags.HAS_DWARF_SPRUCE_SPARSE, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.DWARF_SPRUCE_SPARSE);
		...
		addFeature(context, "mycelium_sprouts", EnvironmentalBiomeTags.HAS_MYCELIUM_SPROUTS, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.PATCH_MYCELIUM_SPROUTS);
		...
		addFeature(context, "flower_forest_vegetation", EnvironmentalBiomeTags.HAS_FOREST_VEGETATION, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.PATCH_DELPHINIUMS, EnvironmentalPlacedFeatures.TREES_WISTERIA);
