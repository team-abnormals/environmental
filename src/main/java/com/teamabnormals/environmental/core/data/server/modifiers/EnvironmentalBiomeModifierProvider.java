...
public class EnvironmentalBiomeModifierProvider {
	...
	public static JsonCodecProvider<BiomeModifier> create(DataGenerator generator, ExistingFileHelper existingFileHelper) {
		...
		addFeatureIgnore("cup_lichen", EnvironmentalBiomeTags.HAS_CUP_LICHEN, EnvironmentalBiomeTags.WITHOUT_CUP_LICHEN, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.PATCH_CUP_LICHEN);
		...
		addFeature("cartwheel", BiomeTags.IS_OVERWORLD, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.FLOWER_CARTWHEEL);
		...
		addFeature("jungle_vegetation", BiomeTags.IS_JUNGLE, Decoration.VEGETAL_DECORATION, EnvironmentalPlacedFeatures.PATCH_GIANT_TALL_GRASS_JUNGLE, EnvironmentalPlacedFeatures.PATCH_LARGE_FERN_JUNGLE);
