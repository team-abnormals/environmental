...
public class EnvironmentalClientCompat {
	...
	private static void registerRenderLayers() {
		...
		ItemBlockRenderTypes.setRenderLayer(EnvironmentalBlocks.ESTUARY_MARIGOLD.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(EnvironmentalBlocks.POTTED_ESTUARY_MARIGOLD.get(), RenderType.cutout());
