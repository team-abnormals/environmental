...
public class EnvironmentalProperties {
	...
	public static final BlockBehaviour.Properties MUD = BlockBehaviour.Properties.of(Material.DIRT, MaterialColor.DIRT).strength(0.5F).sound(SoundType.SLIME_BLOCK).speedFactor(0.2F).isValidSpawn(PropertyUtil::always).isRedstoneConductor(PropertyUtil::always).isViewBlocking(PropertyUtil::always);
