...
public class EnvironmentalTiers {
	public static class Armor {
		public static final BlueprintArmorMaterial EXPLORER = new BlueprintArmorMaterial(new ResourceLocation(Environmental.MOD_ID, "explorer"), 12, new int[]{2, 3, 2, 3}, 17, () -> SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> Ingredient.of(Items.RABBIT_HIDE));
