...
public class EnvironmentalTiers {
	public static class EnvironmentalArmorMaterials {
		...
		public static final BlueprintArmorMaterial YAK = new BlueprintArmorMaterial(new ResourceLocation(Environmental.MOD_ID, "yak"), 5, new int[]{3, 3, 3, 3}, 15, () -> SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> Ingredient.of(EnvironmentalBlocks.YAK_HAIR_BLOCK.get()));
	}
}
