...
public class EnvironmentalBlockFamilies {
	...
	public static final BlockFamily MUD_BRICKS_FAMILY = new BlockFamily.Builder(MUD_BRICKS.get()).wall(MUD_BRICK_WALL.get()).stairs(MUD_BRICK_STAIRS.get()).slab(MUD_BRICK_SLAB.get()).chiseled(CHISELED_MUD_BRICKS.get()).getFamily();
