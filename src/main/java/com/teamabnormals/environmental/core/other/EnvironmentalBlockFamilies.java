...
public class EnvironmentalBlockFamilies {
	...
	public static final BlockFamily SMOOTH_MUD_FAMILY = new BlockFamily.Builder(SMOOTH_MUD.get()).wall(SMOOTH_MUD_WALL.get()).stairs(SMOOTH_MUD_STAIRS.get()).slab(SMOOTH_MUD_SLAB.get()).chiseled(CHISELED_MUD_BRICKS.get()).getFamily();
