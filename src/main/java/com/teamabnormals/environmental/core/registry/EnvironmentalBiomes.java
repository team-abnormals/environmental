...
public class EnvironmentalBiomes {
	...
	private static Biome pineBarrens(boolean snowy) {
		...
		return biome(snowy ? Precipitation.SNOW : Precipitation.RAIN, snowy ? -0.2F : 0.4F, snowy ? 0.4F : 0.6F, snowy ? 8697226 : snowy ? 7710824 : 9090929, 6725203, 4159204, 329011, 12638463, spawns, generation, null);
	}
