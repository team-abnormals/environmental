...
import com.teamabnormals.environmental.client.gui.screens.inventory.SawmillScreen;
...
public class EnvironmentalMenuTypes {
	...
	public static void registerScreenFactories() {
		...
		MenuScreens.register(EnvironmentalMenuTypes.SAWMILL.get(), SawmillScreen::new);
	}
}
