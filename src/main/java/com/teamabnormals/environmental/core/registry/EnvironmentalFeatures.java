...
public class EnvironmentalFeatures {
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> TASSELFLOWERS = FEATURES.register("tasselflowers", () -> new TasselflowersFeature(NoneFeatureConfiguration.CODEC));
	...
	public static final class EnvironmentalConfiguredFeatures {
		...
		public static final RegistryObject<ConfiguredFeature<NoneFeatureConfiguration, ?>> TASSELFLOWERS = register("tasselflowers", () -> new ConfiguredFeature<>(EnvironmentalFeatures.TASSELFLOWERS.get(), NoneFeatureConfiguration.NONE));
	...
	public static final class EnvironmentalPlacedFeatures {
		...
		public static final RegistryObject<PlacedFeature> TASSELFLOWERS = register("tasselflowers", EnvironmentalConfiguredFeatures.TASSELFLOWERS, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
