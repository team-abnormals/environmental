...
public class EnvironmentalFeatures {
	...
	public static final class EnvironmentalPlacedFeatures {
		...
		public static final RegistryObject<PlacedFeature> TREES_WISTERIA = register("trees_wisteria", EnvironmentalConfiguredFeatures.TREES_WISTERIA, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.3F, 2)));
