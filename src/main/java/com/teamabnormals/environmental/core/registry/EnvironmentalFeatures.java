...
public class EnvironmentalFeatures {
	...
	public static final RegistryObject<Feature<NoneFeatureConfiguration>> HIBISCUS_PATCH = FEATURES.register("hibiscus_patch", () -> new HibiscusPatchFeature(NoneFeatureConfiguration.CODEC));
	...
	public static final class EnvironmentalConfiguredFeatures {
		...
		public static final RegistryObject<ConfiguredFeature<NoneFeatureConfiguration, ?>> PATCH_HIBISCUS = register("patch_hibiscus", () -> new ConfiguredFeature<>(EnvironmentalFeatures.HIBISCUS_PATCH.get(), NoneFeatureConfiguration.NONE));
	...
	public static final class EnvironmentalPlacedFeatures {
		...
		public static final RegistryObject<PlacedFeature> PATCH_HIBISCUS = register("patch_hibiscus", EnvironmentalConfiguredFeatures.PATCH_HIBISCUS, RarityFilter.onAverageOnceEvery(64), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());
