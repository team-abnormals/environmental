...
public class EnvironmentalFeatures {
	...
	public static final class EnvironmentalConfiguredFeatures {
		...
		public static final RegistryObject<ConfiguredFeature<DiskConfiguration, ?>> DISK_MUD = register("disk_mud", () -> new ConfiguredFeature<>(Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(EnvironmentalBlocks.MUD.get()), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, EnvironmentalBlocks.MUD.get())), UniformInt.of(1, 4), 1)));
	...
	public static final class EnvironmentalPlacedFeatures {
		...
		public static final RegistryObject<PlacedFeature> FOREST_FLOWERS = register("forest_flowers", EnvironmentalConfiguredFeatures.FOREST_FLOWERS, RarityFilter.onAverageOnceEvery(24), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, CountPlacement.of(ClampedInt.of(UniformInt.of(-3, 1), 0, 1)), BiomeFilter.biome());
