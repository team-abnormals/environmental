...
public class EnvironmentalFeatures {
	...
	public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> CEDAR_SWAMP_HUMMOCKS = FEATURES.register("cedar_swamp_hummocks", () -> new CedarSwampHummocksFeature(NoneFeatureConfiguration.CODEC));
	...
	public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> SMOOTHCAP_MOSS = FEATURES.register("smoothcap_moss", () -> new SmoothcapMossFeature(NoneFeatureConfiguration.CODEC));
	...
	public static final DeferredHolder<Feature<?>, Feature<TreeConfiguration>> CEDAR_TREE = FEATURES.register("cedar_tree", () -> new CedarTreeFeature(NoiseBeehivesTreeConfiguration.CODEC));
