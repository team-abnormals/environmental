...
public class EnvironmentalBlocks {
	...
	public static final RegistryObject<Block> PINK_WISTERIA_LEAVES = HELPER.createBlock("pink_wisteria_leaves", () -> new ColoredWisteriaLeavesBlock(EnvironmentalProperties.leaves(MaterialColor.COLOR_PINK)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> BLUE_WISTERIA_LEAVES = HELPER.createBlock("blue_wisteria_leaves", () -> new ColoredWisteriaLeavesBlock(EnvironmentalProperties.leaves(MaterialColor.COLOR_BLUE)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> PURPLE_WISTERIA_LEAVES = HELPER.createBlock("purple_wisteria_leaves", () -> new ColoredWisteriaLeavesBlock(EnvironmentalProperties.leaves(MaterialColor.COLOR_PURPLE)), CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Block> WHITE_WISTERIA_LEAVES = HELPER.createBlock("white_wisteria_leaves", () -> new ColoredWisteriaLeavesBlock(EnvironmentalProperties.leaves(MaterialColor.SNOW)), CreativeModeTab.TAB_DECORATIONS);
