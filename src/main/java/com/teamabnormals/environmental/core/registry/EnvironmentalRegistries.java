...
public final class EnvironmentalRegistries {
	...
	public static final ResourceKey<Registry<SlabfishVariant>> SLABFISH_VARIANT = create("slabfish_variant");
	public static final ResourceKey<Registry<SlabfishBackpack>> SLABFISH_BACKPACK = create("slabfish_backpack");
	public static final ResourceKey<Registry<SlabfishSweater>> SLABFISH_SWEATER = create("slabfish_sweater");
	public static final ResourceKey<Registry<SlabfishOverlay>> SLABFISH_OVERLAY = create("slabfish_overlay");
	...
	public static void registerRegistries(DataPackRegistryEvent.NewRegistry event) {
		...
		event.dataPackRegistry(SLABFISH_VARIANT, SlabfishVariant.DIRECT_CODEC, SlabfishVariant.DIRECT_CODEC);
