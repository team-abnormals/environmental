...
public class EnvironmentalBoatTypes {
	public static final BoatloadBoatType WILLOW = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Environmental.MOD_ID, "willow"), () -> EnvironmentalBlocks.WILLOW_PLANKS.get().asItem(), () -> EnvironmentalItems.WILLOW_BOAT.get(), () -> EnvironmentalItems.WILLOW_CHEST_BOAT.get(), () -> EnvironmentalItems.WILLOW_FURNACE_BOAT.get(), () -> EnvironmentalItems.LARGE_WILLOW_BOAT.get()));
	public static final BoatloadBoatType WISTERIA = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Environmental.MOD_ID, "wisteria"), () -> EnvironmentalBlocks.WISTERIA_PLANKS.get().asItem(), () -> EnvironmentalItems.WISTERIA_BOAT.get(), () -> EnvironmentalItems.WISTERIA_CHEST_BOAT.get(), () -> EnvironmentalItems.WISTERIA_FURNACE_BOAT.get(), () -> EnvironmentalItems.LARGE_WISTERIA_BOAT.get()));
	public static final BoatloadBoatType CHERRY = BoatloadBoatType.register(BoatloadBoatType.create(new ResourceLocation(Environmental.MOD_ID, "cherry"), () -> EnvironmentalBlocks.CHERRY_PLANKS.get().asItem(), () -> EnvironmentalItems.CHERRY_BOAT.get(), () -> EnvironmentalItems.CHERRY_CHEST_BOAT.get(), () -> EnvironmentalItems.CHERRY_FURNACE_BOAT.get(), () -> EnvironmentalItems.LARGE_CHERRY_BOAT.get()));
	...
	public static final Supplier<Item> WISTERIA_CHEST_BOAT = () -> new ChestBoatItem(WISTERIA);
