...
public class SlabfishModel<E extends Slabfish> extends AgeableListModel<E> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftArm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(16, 14).addBox(0.0F, 0.0F, -1.5F, 1.0F, 3.0F, 3.0F, true), PartPose.offsetAndRotation(5.0F, -4.0F, 0.0F, 0.0F, 0.0F, -0.43633232F));
		PartDefinition rightArm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(16, 14).addBox(-1.0F, 0.0F, -1.5F, 1.0F, 3.0F, 3.0F, false), PartPose.offsetAndRotation(-5.0F, -4.0F, 0.0F, 0.0F, 0.0F, 0.43633232F));
		...
		PartDefinition rightLeg = root.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 14).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F, false), PartPose.offsetAndRotation(-2.5F, 19.0F, 1.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition leftLeg = root.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 14).addBox(-1.5F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F, true), PartPose.offsetAndRotation(2.5F, 19.0F, 1.0F, 0.0F, 0.0F, 0.0F));
