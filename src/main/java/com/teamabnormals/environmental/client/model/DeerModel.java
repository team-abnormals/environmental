...
public class DeerModel<E extends AbstractDeer> extends AgeableListModel<E> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(20, 25).mirror().addBox(-0.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offsetAndRotation(-3.5F, 14.0F, -5.0F, 0.0F, 0.0F, 0.0F));
		root.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(20, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offsetAndRotation(3.5F, 14.0F, -5.0F, 0.0F, 0.0F, 0.0F));
