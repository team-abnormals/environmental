...
public class DeerModel<E extends AbstractDeer> extends AgeableListModel<E> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -9.0F, 8.0F, 8.0F, 17.0F), PartPose.offset(0.0F, 14.0F, 0.0F));
		body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(0, 40).addBox(-1.5F, -3.0F, 0.0F, 3.0F, 3.0F, 3.0F), PartPose.offset(0.0F, -4.0F, 8.0F));
		root.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 25).addBox(-2.5F, -10.0F, -2.0F, 5.0F, 10.0F, 5.0F), PartPose.offset(0.0F, 10.0F, -7.0F));

		PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(33, 0).addBox(-2.5F, -5.0F, -4.0F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.05F)).texOffs(32, 25).addBox(-1.5F, -3.0F, -8.0F, 3.0F, 3.0F, 4.0F, false), PartPose.offset(0.0F, 0.0F, -5.75F));
		head.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(33, 0).mirror().addBox(-1.0F, -4.0F, 0.5F, 1.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(-2.0F, -3.0F, 1.0F, 0.0F, -1.5708F, 0.0F));
		head.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(33, 0).addBox(0.0F, -4.0F, 0.5F, 1.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(2.0F, -3.0F, 1.0F, 0.0F, 1.5708F, 0.0F));
		head.addOrReplaceChild("right_antler", CubeListBuilder.create().texOffs(0, 39).mirror().addBox(-0.5F, -10.0F, 0.0F, 0.0F, 11.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -4.0F, 0.25F, 0.0F, -0.7854F, 0.0F));
		head.addOrReplaceChild("left_antler", CubeListBuilder.create().texOffs(0, 39).addBox(0.5F, -10.0F, 0.0F, 0.0F, 11.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -4.0F, 0.25F, 0.0F, 0.7854F, 0.0F));

		root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(20, 25).mirror().addBox(-0.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offset(-3.5F, 14.0F, -5.0F));
		root.addOrReplaceChild("left_front_leg", CubeListBuilder.create().texOffs(20, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offset(3.5F, 14.0F, -5.0F));
		root.addOrReplaceChild("right_hind_leg", CubeListBuilder.create().texOffs(20, 25).mirror().addBox(-0.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offset(-3.5F, 14.0F, 6.0F));
		root.addOrReplaceChild("left_hind_leg", CubeListBuilder.create().texOffs(20, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F), PartPose.offset(3.5F, 14.0F, 6.0F));

		CubeDeformation cubedeformation = new CubeDeformation(0.0F, 3.0F, 0.0F);
		root.addOrReplaceChild("right_front_baby_leg", CubeListBuilder.create().texOffs(20, 25).mirror().addBox(-0.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F, cubedeformation), PartPose.offset(-3.5F, 14.0F, -5.0F));
		root.addOrReplaceChild("left_front_baby_leg", CubeListBuilder.create().texOffs(20, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F, cubedeformation), PartPose.offset(3.5F, 14.0F, -5.0F));
		root.addOrReplaceChild("right_hind_baby_leg", CubeListBuilder.create().texOffs(20, 25).mirror().addBox(-0.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F, cubedeformation), PartPose.offset(-3.5F, 14.0F, 6.0F));
		root.addOrReplaceChild("left_hind_baby_leg", CubeListBuilder.create().texOffs(20, 25).addBox(-2.5F, 0.0F, -2.0F, 3.0F, 10.0F, 3.0F, cubedeformation), PartPose.offset(3.5F, 14.0F, 6.0F));
