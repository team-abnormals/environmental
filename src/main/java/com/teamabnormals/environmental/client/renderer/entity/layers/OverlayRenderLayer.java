...
@OnlyIn(Dist.CLIENT)
public class OverlayRenderLayer<E extends Slabfish, M extends SlabfishModel<E>> extends RenderLayer<E, M> {

	public OverlayRenderLayer(RenderLayerParent<E, M> entityRenderer) {
