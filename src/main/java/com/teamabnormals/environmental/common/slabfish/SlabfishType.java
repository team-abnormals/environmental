...
public class SlabfishType extends ForgeRegistryEntry<SlabfishType> implements Predicate<SlabfishConditionContext> {
    ...
    public static final Map<TagKey<SlabfishType>, Pair<Float, ChatFormatting>> RARITIES = Util.make(new HashMap<>(), map -> {
        map.put(EnvironmentalTags.SlabfishTypes.COMMON, Pair.of(1.0F, ChatFormatting.GRAY));
        map.put(EnvironmentalTags.SlabfishTypes.UNCOMMON, Pair.of(0.55F, ChatFormatting.GREEN));
        map.put(EnvironmentalTags.SlabfishTypes.RARE, Pair.of(0.15F, ChatFormatting.AQUA));
        map.put(EnvironmentalTags.SlabfishTypes.EPIC, Pair.of(0.8F, ChatFormatting.LIGHT_PURPLE));
        map.put(EnvironmentalTags.SlabfishTypes.LEGENDARY, Pair.of(0.2F, ChatFormatting.GOLD));
    });
    ...
    public static TagKey<SlabfishType> getRandomRarity(float chance) {
        ...
        return EnvironmentalTags.SlabfishTypes.COMMON;
    }
