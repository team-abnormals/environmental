...
public class MoodyCherryTreeGrower extends AbstractTreeGrower {

	@Nullable
	protected Holder<? extends ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource random, boolean beehive) {
		return beehive ? EnvironmentalConfiguredFeatures.MOODY_CHERRY_BEES_005.getHolder().get() : EnvironmentalConfiguredFeatures.MOODY_CHERRY.getHolder().get();
	}
}